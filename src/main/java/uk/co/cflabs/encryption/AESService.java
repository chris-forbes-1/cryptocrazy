...
public class AESService
{
	...
	public Optional<EncryptedResponse> encrypt(String message)
	{
		try
		{
			logger.info("Encrypting messaged: [{}]", message);
	...
	public Optional<String> decrypt(EncryptedResponse response)
	{
